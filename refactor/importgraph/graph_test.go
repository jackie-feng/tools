...
import (
	...
	"github.com/jackie-feng/tools/refactor/importgraph"

	_ "crypto/hmac" // just for test, below
)

const this = "github.com/jackie-feng/tools/refactor/importgraph"

func TestBuild(t *testing.T) {
	exported := packagestest.Export(t, packagestest.GOPATH, []packagestest.Module{
		{Name: "github.com/jackie-feng/tools/refactor/importgraph", Files: packagestest.MustCopyFileTree(".")}})
