...
import (
	myFoo "github.com/jackie-feng/tools/internal/lsp/foo" //@mark(myFoo, "myFoo"),godef("myFoo", myFoo)
	"github.com/jackie-feng/tools/internal/lsp/godef/a"   //@mark(AImport, re"\".*\"")
)
