...
import (
	...
	"github.com/jackie-feng/tools/internal/lsp/foo" //@link(`github.com/jackie-feng/tools/internal/lsp/foo`,`https://pkg.go.dev/github.com/jackie-feng/tools/internal/lsp/foo`)
